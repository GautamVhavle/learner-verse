...
def upgrade() -> None:
    ...
    op.create_index('idx_study_notes_user_lesson', 'study_notes', ['user_id', 'lesson_id'], unique=True)

    op.create_table('course_study_state',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    op.create_index('idx_study_state_user_course', 'course_study_state', ['user_id', 'course_id'], unique=True)
