...
Check when the site serves multiple languages or regions. Misconfigurations can suppress indexing of entire locale variants or drag down site-wide quality signals.
...
**Check for:**
- Consistent locale prefix strategy; all locales prefixed
...
- **frontend-design**: For optimizing pages for visual quality and UX
